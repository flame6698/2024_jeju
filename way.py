...
class move_limo:
    def __init__(self):
        ...
        rospy.Subscriber("/main_cmd_way", Bool, self.main_cmd_way_callback)  # 추가
    ...
    def main_cmd_way_callback(self, data):  # 추가
